...
<aui:form action="<%=editGuestbookURL%>" name="<portlet:namespace />fm">
	...
	<liferay-ui:panel defaultState="closed" extended="<%=false%>" id="guestbookCategorizationPanel"
	...
	<liferay-ui:panel defaultState="closed" extended="<%=false%>" id="guestbookAssetLinksPanel"
