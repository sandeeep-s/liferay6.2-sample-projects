...
<portlet:actionURL name="addEntry" var="addEntryURL">
	<portlet:param name="guestbookName" value="<%=guestbook.getName()%>" />
	<portlet:param name="action" value="addEntry"/>
</portlet:actionURL>
...
<aui:form action="<%=addEntryURL%>" name="fm">
	...
	<aui:fieldset>
		...
		<aui:input name="message" type="textarea" id="message">
	...
	<liferay-ui:panel defaultState="closed" extended="<%=false%>" id="populatePanel" persistState="<%=true%>"
		title="populate">
	...
	<liferay-ui:panel defaultState="closed" extended="<%=false%>" id="entryCategorizationPanel" persistState="<%=true%>"
