...
<%@ page import="com.liferay.docs.guestbook.permission.GuestbookModelPermission"%>
<%@ page import="com.liferay.docs.guestbook.permission.GuestbookPermission"%>
<%@ page import="com.liferay.docs.guestbook.permission.EntryPermission"%>
